...
class Constants(BaseConstants):
    name_in_url = 'postquestionnaireB'
...
#mail
    mail1 = models.LongStringField(
        label='10. How do you feel about the benefit of asking for information instead of the "Referring Information"?',
    )
    mail2 =models.IntegerField(
        label='11. What statement fits most to your experience in this game?',
        choices=[
            [0,'I would not want to replace the possibility to ask by the information provided by the system'
                ' (="Referring Information").'],
            [1,'I see the same influence from both information sources.'],
            [2,'The "Referring Information" is more efficient than asking for information.'],
            [3,'I would prefer to have regular meetings.'],
        ],
        widget=widgets.RadioSelect,
    )
