...
SESSION_CONFIGS = [
    {
        'name': 'Real',
        'display_name': 'Decision Game 04.07.',
        'num_demo_participants': 3,
        'app_sequence':['Intro','Experiment','postquestionnaire'],
    },
    {'name': 'RealB',
        'display_name': 'Decision Game B',
        'num_demo_participants': 3,
        'app_sequence':['Intro','ExperimentB','postquestionnaireB'],
     },
    {
        'name': 'Experiment',
        'display_name': 'Test Game A',
        'num_demo_participants': 3,
        'app_sequence':['Experiment'],
    },
    {
        'name': 'ExperimentB',
        'display_name': 'Test Game B',
        'num_demo_participants': 3,
        'app_sequence':['ExperimentB'],
    },
    {
        'name':'Postquest',
        'display_name': 'Postqu.A',
    ...
    {
        'name':'PostquestB',
        'display_name': 'Postqu.B',
        'num_demo_participants': 2,
        'app_sequence': ['postquestionnaireB'],
